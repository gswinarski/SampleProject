---
id: TOPIC-ISSUE
title: FTTH customer issues and faults
type: topic
topic_id: ISSUE
status: draft
relates_to:
...
# FTTH customer issues and faults

> Fictional B2C fiber broadband operator. Status: proposal for review.

- [Business process](doc:BP-ISSUE)
- [Acceptance criteria](doc:AC-ISSUE)
- [Solution design](doc:SD-ISSUE)
- [UAT scenarios](doc:TEST-ISSUE)
