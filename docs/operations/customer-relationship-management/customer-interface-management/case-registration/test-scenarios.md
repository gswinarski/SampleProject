...
| UAT-CR06 | Customer selects "no internet" as the category | Case created and handed to customer issues and faults | AC-CASEREG-06 |
| UAT-CR07 | Customer selects "disputed charge" as the category | Case created and handed to billing complaints | AC-CASEREG-07 |
| UAT-CR08 | Customer selects "general question" as the category | Case created and queued; no hand-off | AC-CASEREG-08 |
