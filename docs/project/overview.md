---
id: PROJECT-OVERVIEW
title: B2C FTTH operator project
type: project
topic_id: PROJECT
status: draft
relates_to:
...
- TELCO-005: postal-code address lookup and coverage check — the pre-sales screening step ahead of TELCO-002's technical qualification.
...
## Out of scope
Salesforce deployment, offer selection, ordering, executing financial adjustments and real connections to operator systems.
